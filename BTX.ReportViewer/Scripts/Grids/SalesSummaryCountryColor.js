//SalesByProducts
app.controller('SalesSummaryCountryColorCtrl', SalesSummaryCountryColorCtrl);

SalesSummaryCountryColorCtrl.$inject = ['$http', '$scope', 'GroupDropDown', 'uiGridConstants','GroupService'];
function SalesSummaryCountryColorCtrl($http, $scope, GroupDropDown, uiGridConstants, GroupService) {

    //UI Grid Setting
    $scope.grid = {
        columnDefs: [

            { name: 'Color', field: "Color", width: 200, cellTemplate: '<div class="ui-grid-cell-contents" style="text-align:left;"><a ng-click="grid.appScope.salessubgrid(row.entity.Color)" style="cursor:pointer;">{{COL_FIELD}}</a></div>', footerCellTemplate: '<div class="ui-grid-cell-contents">Total:</div>' },
            ...
            { name: 'TY13_OnPremPct', field: "TY13_OnPremPct", displayName: "Var %", width: 115, cellFilter: 'mapPercentage', type: 'number', footerCellTemplate: '<div class="ui-grid-cell-contents" style="text-align:right;"><span id="Color_TY13_OnPremPct"></span></div>' },
        ...
        exporterCsvFilename: 'Sales Summary by Country Color Detail - ' + document.getElementById('CountryName').value + '.csv',
    ...
    //load subgrid
    $scope.salessubgrid = function (color) {
        var period = document.getElementById("SalesPeriod").value;
        var setnames = document.getElementById("SalesSetNames").value;
        var unitsizes = document.getElementById("SalesUnitSizes").value;
        ...
        f.setAttribute('id', "salesbycountryproductsubgridform");
        f.setAttribute('method', "post");
        f.setAttribute('action', document.getElementById('SalesSummaryCountryColorProductUrl').value);
        ...
        f.appendChild(GroupDropDown.createFormElement("colorname", color));
