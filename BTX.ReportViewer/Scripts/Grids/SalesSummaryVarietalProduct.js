//SalesByProducts
app.controller('SalesSummaryVarietalProductCtrl', SalesSummaryVarietalProductCtrl);

SalesSummaryVarietalProductCtrl.$inject = ['$http', '$scope', 'GroupDropDown', 'uiGridConstants','GroupService'];
function SalesSummaryVarietalProductCtrl($http, $scope, GroupDropDown, uiGridConstants, GroupService) {
    ...
    $scope.grid = {
        columnDefs: [
            ...
            { name: 'Week1', field: "Week1", width: 120, cellFilter: 'number:0', type: 'number', aggregationType: uiGridConstants.aggregationTypes.sum, aggregationHideLabel: true, footerCellTemplate: '<div class="ui-grid-cell-contents">{{col.getAggregationValue()|number:0}}</div>' },
            { name: 'Week2', field: "Week2", width: 120, cellFilter: 'number:0', type: 'number', aggregationType: uiGridConstants.aggregationTypes.sum, aggregationHideLabel: true, footerCellTemplate: '<div class="ui-grid-cell-contents">{{col.getAggregationValue()|number:0}}</div>' },
            { name: 'Week3', field: "Week3", width: 120, cellFilter: 'number:0', type: 'number', aggregationType: uiGridConstants.aggregationTypes.sum, aggregationHideLabel: true, footerCellTemplate: '<div class="ui-grid-cell-contents">{{col.getAggregationValue()|number:0}}</div>' },
            { name: 'Week4', field: "Week4", width: 120, cellFilter: 'number:0', type: 'number', aggregationType: uiGridConstants.aggregationTypes.sum, aggregationHideLabel: true, footerCellTemplate: '<div class="ui-grid-cell-contents">{{col.getAggregationValue()|number:0}}</div>' },
            ...
            { name: 'TY13_OnPremPct', field: "TY13_OnPremPct", displayName: "Var %", width: 70, cellFilter: 'mapPercentage', type: 'number', footerCellTemplate: '<div class="ui-grid-cell-contents" style="text-align:right;"><span id="Product_TY13_OnPremPct"></span></div>' },
        ...
        exporterCsvFilename: 'Sales Summary by Varietal Product Detail - ' + document.getElementById('VarietalName').value + '.csv',
    ...
    function init() {
        ...
        $http({
            ...
            function (result) {
                ...
                var product_ty6m_totalsalesamountpct = document.getElementById("Product_TY6m_TotalSalesAmountPct");
