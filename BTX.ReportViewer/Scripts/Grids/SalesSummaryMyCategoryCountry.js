//SalesByProducts
app.controller('SalesSummaryMyCategoryCountryCtrl', SalesSummaryMyCategoryCountryCtrl);

SalesSummaryMyCategoryCountryCtrl.$inject = ['$http', '$scope', 'GroupDropDown', 'uiGridConstants','GroupService'];
function SalesSummaryMyCategoryCountryCtrl($http, $scope, GroupDropDown, uiGridConstants, GroupService) {
    ...
    $scope.grid = {
        columnDefs: [
            ...
            { name: 'TY13_OnPremPct', field: "TY13_OnPremPct", displayName: "Var %", width: 115, cellFilter: 'mapPercentage', type: 'number', footerCellTemplate: '<div class="ui-grid-cell-contents" style="text-align:right;"><span id="Country_TY13_OnPremPct"></span></div>' },
        ...
        exporterCsvFilename: 'Sales Summary by Category Country Detail - ' + document.getElementById('MyCategoryName').value + '.csv',
    ...
    function init() {
        ...
        $http({
            ...
            headers: {
                ...
                "X-PriceTo": priceto,
                "X-MyCategoryName": mycategoryname
            }
        }).
            then(
            function (result) {
    ...
    $scope.salessubgrid = function (country) {
        ...
        f.setAttribute('id', "salesbymycategorycountrysubgridform");
        f.setAttribute('method', "post");
        f.setAttribute('action', document.getElementById('SalesSummaryMyCategoryCountryProductUrl').value);
