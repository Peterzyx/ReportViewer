//SalesByPriceBandMyCategoryProduct
app.controller('SalesSummaryPriceBandCategoryProductCtrl', SalesSummaryPriceBandCategoryProductCtrl);

SalesSummaryPriceBandCategoryProductCtrl.$inject = ['$http', '$scope', 'GroupDropDown', 'uiGridConstants','GroupService'];
function SalesSummaryPriceBandCategoryProductCtrl($http, $scope, GroupDropDown, uiGridConstants, GroupService) {
    ...
    $scope.grid = {
        ...
        exporterCsvFilename: 'Sales Summary by Price Band - ' + document.getElementById('PriceBandName').value + ' Category ' + document.getElementById('MyCategoryName').value + '.csv',
