//SalesByProducts
app.controller('SalesSummaryCountryColorProductCtrl', SalesSummaryCountryColorProductCtrl);

SalesSummaryCountryColorProductCtrl.$inject = ['$http', '$scope', 'GroupDropDown', 'uiGridConstants','GroupService'];
function SalesSummaryCountryColorProductCtrl($http, $scope, GroupDropDown, uiGridConstants, GroupService) {
    ...
    $scope.grid = {
        ...
        exporterCsvFilename: 'Sales Summary by Country ' + document.getElementById('CountryName').value + ' Color - ' + document.getElementById('ColorName').value + '.csv',
    ...
    function init() {
        ...
        $http({
            url: "/SalesSummaryCountryColorProduct",
            dataType: 'json',
            method: 'GET',
            data: '',
            headers: {
