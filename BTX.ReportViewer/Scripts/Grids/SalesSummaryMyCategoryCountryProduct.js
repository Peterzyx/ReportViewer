//SalesByProducts
app.controller('SalesSummaryMyCategoryCountryProductCtrl', SalesSummaryMyCategoryCountryProductCtrl);

SalesSummaryMyCategoryCountryProductCtrl.$inject = ['$http', '$scope', 'GroupDropDown', 'uiGridConstants','GroupService'];
function SalesSummaryMyCategoryCountryProductCtrl($http, $scope, GroupDropDown, uiGridConstants, GroupService) {
    ...
    $scope.grid = {
        ...
        exporterCsvFilename: 'Sales Summary by Category - ' + document.getElementById('MyCategoryName').value + ' Country ' + document.getElementById('CountryName').value + '.csv',
