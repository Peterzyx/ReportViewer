//SalesByPriceBand
app.controller('SalesSummaryPriceBandCategoryCtrl', SalesSummaryPriceBandCategoryCtrl);

SalesSummaryPriceBandCategoryCtrl.$inject = ['$http', '$scope', 'GroupDropDown', 'uiGridConstants','GroupService'];
function SalesSummaryPriceBandCategoryCtrl($http, $scope, GroupDropDown, uiGridConstants, GroupService) {

    //UI Grid Setting
    $scope.grid = {
        columnDefs: [

            { name: 'MyCategory', field: "MyCategory", displayName:"Category", width: 200, cellTemplate: '<div class="ui-grid-cell-contents" style="text-align:left;"><a ng-click="grid.appScope.salessubgrid(row.entity.MyCategory)" style="cursor:pointer;">{{COL_FIELD}}</a></div>', footerCellTemplate: '<div class="ui-grid-cell-contents">Total:</div>' },
            ...
            { name: 'TY_9LCasesPct', field: "TY_9LCasesPct", displayName: "Var %", width: 70, cellFilter: 'mapPercentage', type: 'number', footerCellTemplate: '<div class="ui-grid-cell-contents" style="text-align:right;"><span id="Category_TY_9LCasesPct"></span></div>' },
            ...
            { name: 'TY_UnitsPct', field: "TY_UnitsPct", displayName: "Var %", width: 70, cellFilter: 'mapPercentage', visible: false, type: 'number', footerCellTemplate: '<div class="ui-grid-cell-contents" style="text-align:right;"><span id="Category_TY_UnitsPct"></span></div>' },
            ...
            { name: 'TY_TotalSalesAmountPct', field: "TY_TotalSalesAmountPct", displayName: "Var %", width: 70, cellFilter: 'mapPercentage', visible: false, type: 'number', footerCellTemplate: '<div class="ui-grid-cell-contents" style="text-align:right;"><span id="Category_TY_TotalSalesAmountPct"></span></div>' },
            ...
            { name: 'TY_TD_9LCasesPct', field: "TY_TD_9LCasesPct", displayName: "Var %", width: 70, cellFilter: 'mapPercentage', type: 'number', visible:false, footerCellTemplate: '<div class="ui-grid-cell-contents" style="text-align:right;"><span id="Category_TY_TD_9LCasesPct"></span></div>' },
            ...
            { name: 'TY_TD_UnitsPct', field: "TY_TD_UnitsPct", displayName: "Var %", width: 70, cellFilter: 'mapPercentage', visible: false, type: 'number', footerCellTemplate: '<div class="ui-grid-cell-contents" style="text-align:right;"><span id="Category_TY_TD_UnitsPct"></span></div>' },
            ...
            { name: 'TY_TD_TotalSalesAmountPct', field: "TY_TD_TotalSalesAmountPct", displayName: "Var %", width: 70, cellFilter: 'mapPercentage', visible: false, type: 'number', footerCellTemplate: '<div class="ui-grid-cell-contents" style="text-align:right;"><span id="Category_TY_TD_TotalSalesAmountPct"></span></div>' },
            ...
            { name: 'TY6m_9LCasesPct', field: "TY6m_9LCasesPct", displayName: "Var %", width: 70, cellFilter: 'mapPercentage', type: 'number', footerCellTemplate: '<div class="ui-grid-cell-contents" style="text-align:right;"><span id="Category_TY6m_9LCasesPct"></span></div>' },
            ...
            { name: 'TY6m_UnitsPct', field: "TY6m_UnitsPct", displayName: "Var %", width: 70, cellFilter: 'mapPercentage', visible: false, type: 'number', footerCellTemplate: '<div class="ui-grid-cell-contents" style="text-align:right;"><span id="Category_TY6m_UnitsPct"></span></div>' },
            ...
            { name: 'TY6m_TotalSalesAmountPct', field: "TY6m_TotalSalesAmountPct", displayName: "Var %", width: 70, cellFilter: 'mapPercentage', visible: false, type: 'number', footerCellTemplate: '<div class="ui-grid-cell-contents" style="text-align:right;"><span id="Category_TY6m_TotalSalesAmountPct"></span></div>' },
            ...
            { name: 'TYYTD_9LCasesPct', field: "TYYTD_9LCasesPct", displayName: "Var %", width: 70, cellFilter: 'mapPercentage', type: 'number', footerCellTemplate: '<div class="ui-grid-cell-contents" style="text-align:right;"><span id="Category_TYYTD_9LCasesPct"></span></div>' },
            ...
            { name: 'TYYTD_UnitsPct', field: "TYYTD_UnitsPct", displayName: "Var %", width: 70, cellFilter: 'mapPercentage', visible: false, type: 'number', footerCellTemplate: '<div class="ui-grid-cell-contents" style="text-align:right;"><span id="Category_TYYTD_UnitsPct"></span></div>' },
            ...
            { name: 'TYYTD_SalesAmountPct', field: "TYYTD_SalesAmountPct", displayName: "Var %", width: 70, cellFilter: 'mapPercentage', visible: false, type: 'number', footerCellTemplate: '<div class="ui-grid-cell-contents" style="text-align:right;"><span id="Category_TYYTD_SalesAmountPct"></span></div>' },
            ...
            { name: 'TY13_OnPremPct', field: "TY13_OnPremPct", displayName: "Var %", width: 115, cellFilter: 'mapPercentage', type: 'number', footerCellTemplate: '<div class="ui-grid-cell-contents" style="text-align:right;"><span id="Category_TY13_OnPremPct"></span></div>' },
            ...
            { name: 'TY13AmountPct', field: "TY13AmountPct", displayName: "Var %", width: 70, cellFilter: 'mapPercentage', type: 'number', footerCellTemplate: '<div class="ui-grid-cell-contents" style="text-align:right;"><span id="Category_TY13AmountPct"></span></div>' }
        ...
        exporterCsvFilename: 'Sales Summary by Price Band Country Detail - ' + document.getElementById('PriceBandName').value + '.csv',
    ...
    function init() {
        ...
        $http({
            url: "/SalesSummaryPriceBandCategory",
            dataType: 'json',
            method: 'GET',
            data: '',
            headers: {
            ...
            function (result) {
                ...
                var category_ty_9Lcasespct = document.getElementById("Category_TY_9LCasesPct");
                if (category_ty_9Lcasespct)
                    category_ty_9Lcasespct.textContent = (result.data[0].TY_9LCasesPct * 100).toFixed(2).toString() + "%";

                var category_ty_unitspct = document.getElementById("Category_TY_UnitsPct");
                if (category_ty_unitspct)
                    category_ty_unitspct.textContent = (result.data[0].TY_UnitsPct * 100).toFixed(2).toString() + "%";

                var category_ty_totalsalesamountpct = document.getElementById("Category_TY_TotalSalesAmountPct");
                if (category_ty_totalsalesamountpct)
                    category_ty_totalsalesamountpct.textContent = (result.data[0].TY_TotalSalesAmountPct * 100).toFixed(2).toString() + "%";

                var category_ty_td_9Lcasespct = document.getElementById("Category_TY_TD_9LCasesPct");
                if (category_ty_td_9Lcasespct)
                    category_ty_td_9Lcasespct.textContent = (result.data[0].TY_9LCasesPct * 100).toFixed(2).toString() + "%";

                var category_ty_td_unitspct = document.getElementById("Category_TY_TD_UnitsPct");
                if (coountry_ty_td_unitspct)
                    category_ty_td_unitspct.textContent = (result.data[0].TY_UnitsPct * 100).toFixed(2).toString() + "%";

                var category_ty_td_totalsalesamountpct = document.getElementById("Category_TY_TD_TotalSalesAmountPct");
                if (category_ty_td_totalsalesamountpct)
                    category_ty_td_totalsalesamountpct.textContent = (result.data[0].TY_TotalSalesAmountPct * 100).toFixed(2).toString() + "%";

                var category_ty6m_9Lcasespct = document.getElementById("Category_TY6m_9LCasesPct");
                if (category_ty6m_9Lcasespct)
                    category_ty6m_9Lcasespct.textContent = (result.data[0].TY6m_9LCasesPct * 100).toFixed(2).toString() + "%";

                var category_ty6m_unitspct = document.getElementById("Category_TY6m_UnitsPct");
                if (category_ty6m_unitspct)
                    category_ty6m_unitspct.textContent = (result.data[0].TY6m_UnitsPct * 100).toFixed(2).toString() + "%";

                var category_ty6m_totalsalesamountpct = document.getElementById("Category_TY6m_TotalSalesAmountPct");
                if (category_ty6m_totalsalesamountpct)
                    category_ty6m_totalsalesamountpct.textContent = (result.data[0].TY6m_TotalSalesAmountPct * 100).toFixed(2).toString() + "%";

                var category_tyytd_9Lcasespct = document.getElementById("Category_TYYTD_9LCasesPct");
                if (category_tyytd_9Lcasespct)
                    category_tyytd_9Lcasespct.textContent = (result.data[0].TYYTD_9LCasesPct * 100).toFixed(2).toString() + "%";

                var category_tyytd_unitspct = document.getElementById("Category_TYYTD_UnitsPct");
                if (category_tyytd_unitspct)
                    category_tyytd_unitspct.textContent = (result.data[0].TYYTD_UnitsPct * 100).toFixed(2).toString() + "%";

                var category_tyytd_totalsalesamountpct = document.getElementById("Category_TYYTD_SalesAmountPct");
                if (category_tyytd_totalsalesamountpct)
                    category_tyytd_totalsalesamountpct.textContent = (result.data[0].TYYTD_SalesAmountPct * 100).toFixed(2).toString() + "%";

                var category_ty13_onprempct = document.getElementById("Category_TY13_OnPremPct");
                if (category_ty13_onprempct)
                    category_ty13_onprempct.textContent = (result.data[0].TY13_OnPremPct * 100).toFixed(2).toString() + "%";

                var category_ty13amountpct = document.getElementById("Category_TY13AmountPct");
                if (category_ty13amountpct)
                    category_ty13amountpct.textContent = (result.data[0].TY13AmountPct * 100).toFixed(2).toString() + "%";
            },
            function (error) {
    ...
    //load subgrid
    $scope.salessubgrid = function (mycategory) {
        var period = document.getElementById("SalesPeriod").value;
        var setnames = document.getElementById("SalesSetNames").value;
        var unitsizes = document.getElementById("SalesUnitSizes").value;
        ...
        f.setAttribute('id', "salesbypricebandcategorysubgridform");
        f.setAttribute('method', "post");
        f.setAttribute('action', document.getElementById('SalesSummaryPriceBandCategoryProductUrl').value);
        ...
        f.appendChild(GroupDropDown.createFormElement("mycategoryname", mycategory));
